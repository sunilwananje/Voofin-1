    ...
    function postLogin() {
        ...
        if (isset($user->type) && $user->type) {
            ...
            if (Auth::attempt(['email' => $email, 'password' => $password])) {
                session(['userName' => $user->name,'userEmail' => $user->email,'userId' => $user->id, 'user_type' => $user->user_type,'role_id'=>$user->role_id, 'company_id'=>$user->company_id,'company_conf'=>$user->configurations]);
