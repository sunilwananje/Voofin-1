                  ...
                  <form class="form-horizontal ng-pristine ng-valid" role="form" name="search_poi" action="" method="">
                      <div class="form-group">
                        <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
                          <input type="text" name="buyerSellerSearch" class="form-control ng-pristine ng-untouched ng-valid" id="serch" ng-model="search" placeholder="Search">
                        </div>
						
						<div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">  
						 <select name="bandSearch" class="form-control">
							  <option >Change Bands</option>
					 ...
					 <table class="table table-responsive table-striped table-bordered table-hover no-margin">
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td>{{$dataVal->bandName}} <i class="fa fa-info-circle fa-lg" title="{!! 'Discounting:'.$dataVal->discounting.', Manual Discounting:'.$dataVal->manualDiscounting.', Autodiscounting:'.$dataVal->autoDiscounting !!}"></i></td>
                              <td>
