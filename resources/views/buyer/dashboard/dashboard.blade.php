            ...
            <div class="col-lg-3 col-md-3 col-sm-6 col5">
              <div class="mini-widget">
                ...
                <div class="mini-widget-body clearfix">
                  ...
                  <div class="pull-right number"> ৳ 200,000</div>
                </div>
       ...
       <div class="col-lg-3 col-md-3 col-sm-6 col5">
              <div class="mini-widget">
                ...
                <div class="mini-widget-body clearfix">
                  ...
                  <div class="pull-right number">৳ 491,000</div>
                </div>
<!--                 <div class="mini-widget-footer center-align-text">
                  <span>Better than last week</span>
                </div> -->
        ...
        <div class="table-responsive">
          ...
          <tbody>
            ...
            <td class="hidden-phone">
              <a href="#" class="link_A_blue" data-toggle="modal" data-target="#myModal_po">PO25378</a>
            </td>
            <td>
              <a href="#" class="link_A_blue" data-toggle="modal" data-target="#pi_modal">IN43765</a>
            </td>
            ...
            <td class="hidden-phone">
               <i class="fa fa-check-circle fa-lg green_ntf"></i> Submited            
            </td>
            ...
            <td class="hidden-phone">
              <a href="#" class="link_A_blue">PO000002</a>
            </td>
            <td>
              <a href="#" class="link_A_blue">IN000002</a>	
            </td>
                        ...
                        <table class="table table-responsive table-striped table-bordered table-hover no-margin">
                         ...
                         <tbody>          
                            <tr>
                              <td>MRF</td>
                              <td>
                                <a href="#" data-toggle="modal" data-target="#myModal_po"
                                class="poView link_A_blue" >PO 12376</a>
                              </td>              
                              <td>
                                 ৳22,000,00                                     
                              </td> 
                            ...
                            <tr>
                              ...
                              <td>
                                ...
                                class="poView link_A_blue">PO 453476</a>
                              </td>              
                              <td>
                                 ৳67,000,00                                        
                              </td> 
                            ...
                            <tr>
                              ...
                              <td>
                                <a href="javascript:void(0)" data-id="dwd" data-toggle="modal" 
                                class="poView link_A_blue">PO 56376</a>
                              </td>              
                              <td>
                                 ৳10,000,00       
                              </td> 
