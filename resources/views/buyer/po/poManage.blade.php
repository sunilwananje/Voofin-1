...
@section('sidebar')
<ul>
	<li><a href="" class="heading">BUYER CREATE PO <i class="fa fa-info-circle" title="Lorem Ipsum is simply dummy text of the printing and typesetting industry."></i></a></li>
</ul>	
@stop
@section('content')
<!-- Row Start -->
...
role="form" confirm-on-exit="" novalidate="" method="post" action="{{ route('buyer.poListing.save') }}" enctype="multipart/form-data">
{{ csrf_field() }}
<div class="row">
		...
		<div class="widget">
			...
			<div class="widget-body dsk_mr80">
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type='text' id="purOrderNumber" class="form-control" placeholder="PO Number" name="purchase_order_number" value="{{$poData->purchase_order_number or ''}}" />
							 <span id="poOrderNumberMsg" style="color:red"></span>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<select name="type" class="form-control ng-pristine ng-untouched ng-invalid ng-invalid-required" id="test">
					...
					<div class="form-group">
						...
						<div class="form-group">
							<label for="buyer" class="col-sm-4 control-label">Remark<i class="fa fa-asterisk req_asterisk"></i></label>
							<div class="col-sm-5">
						...
						<div class="form-horizontal no-margin ng-valid-parse ng-invalid ng-invalid-required ng-valid-min ng-valid-pattern ng-pristine" name="addPoi" role="form" confirm-on-exit="" novalidate=""> 
							...
							@if(isset($poItemData) && count($poItemData) > 0)
								...
								<div class="form-group" id="add_item">
									...
									<div class="col-sm-2">
										<input type="text" name="pricePer[]" class="form-control ng-pristine ng-untouched ng-invalid ng-invalid-required pricePer"  placeholder="Price Per" value="{{$poItemVal->unit_price or ''}}">
									</div>
							...
							@else
								...
								<div class="col-sm-2">
									<input type="text" name="pricePer[]" class="form-control ng-pristine ng-untouched ng-invalid ng-invalid-required pricePer"  placeholder="Price Per" 
