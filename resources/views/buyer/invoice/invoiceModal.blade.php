...
<div class="modal-content" id="invoiceData">
      <div class="modal-header">
        ...
        @if($invData->invoice[0]->status!=5) 
          <button type="button" data-toggle="modal" data-target="#confirmApproveMoadal"><i class="fa fa-check-circle fa-lg"></i> Approve</button>
              ...
              <tbody>
               ...
               @endforeach 
                ...
                <tr>
                  ...
                  <td>&nbsp;</td>
                  <td class="hidden-phone">
                    {{ $symbol }}{{number_format($invData->invoice[0]->discount,2)}}
                  </td>
                </tr>
                ...
                <tr class="success">
                  ...
                  <td>&nbsp;</td>
                  <td class="hidden-phone">
                    {{ $symbol }}{{number_format($invData->invoice[0]->final_amount,2)}}
                  </td>
                </tr>
              </tbody>
            </table>
...
<!-- Approve Invoice Modal Start  -->
     <div class="modal fade" id="attachModal" role="dialog" aria-labelledby="confirmAttachLabel" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <form action="{{ route('buyer.invoice.upload',[$invData->invoice[0]->id]) }}" method="post" enctype="multipart/form-data">
          {{ csrf_field() }}
          <div class="modal-body">
            <div class="row">
              <div class="col-md-12">
    ...
    @if(\Entrust::can('buyer.invoice.checker'))
    ...
    <div class="modal fade" id="confirmApproveMoadal" role="dialog" aria-labelledby="confirmDeleteLabel" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <form class="form-horizontal no-margin ng-valid-parse ng-invalid ng-invalid-required ng-valid-min ng-valid-pattern ng-pristine" id="tdsIvoice" role="form" method="post" action="{{route('buyer.piListing.save')}}">
          {{ csrf_field() }}
          <div class="modal-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <input type="text" class="form-control ng-pristine ng-untouched ng-invalid ng-invalid-required" id="subTotal" name="sub_total" placeholder="Discount" value="{{ $invData->invSubTotal}}">
                  </div>  
                </div>
                <div class="form-group">
                  <label for="tds" class="col-sm-4 control-label">TDS</label>
                  <div class="col-sm-4">
                    <input type="text" class="form-control ng-pristine ng-untouched ng-invalid ng-invalid-required" id="tds" name="tds" placeholder="TDS Percent" value="{{$invData->invoice[0]->tax_percentage}}" readonly>
                  </div>  
                </div>
                ...
                @if(isset($invData->invoice[0]->tax_details) && !empty($invData->invoice[0]->tax_details))
                 @foreach(json_decode($invData->invoice[0]->tax_details) as $key=>$taxDet)
                  <div class="form-group">
                    ...
                    <div class="col-sm-4">
                      <input type="text" class="form-control ng-pristine ng-untouched ng-invalid ng-invalid-required" id="tax" name="tax" placeholder="Tax Percent" readonly>
                ...
                <input type="hidden" name="seller_id" value="{{$invData->invoice[0]->seller_uuid}}">
                <input type="hidden" name="invoice_id" value="{{$invData->invoice[0]->uuid}}">
          </div>
          <div class="modal-footer">
          <input type="hidden" class="route_url">
     ...
     @else
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-footer">
          <input type="hidden" class="route_url">
            <a href="{{route('buyer.invoice.approve',[$invData->invoice[0]->uuid])}}" class="btn btn-success" id="confirmApprove">Approve</a>
            <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
     ...
     <div class="modal fade" id="confirmRejectMoadal" role="dialog" aria-labelledby="confirmDeleteLabel" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <form class="form-horizontal no-margin ng-valid-parse ng-invalid ng-invalid-required ng-valid-min ng-valid-pattern ng-pristine" role="form" method="post" action="{{route('buyer.invoice.reject')}}">
          {{ csrf_field() }}
          <div class="modal-body">
