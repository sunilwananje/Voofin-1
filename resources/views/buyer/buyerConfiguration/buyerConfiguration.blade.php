					...
					<div class="widget">
						...
						<div class="widget-body dsk_mr80">
							...
							<div class="form-group">
									<label for="buyer" class="col-sm-6">Bank Name<i class="fa fa-asterisk req_asterisk"></i> 
									<span class="help-block" style="font-weight:normal;">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s</span>
									</label>
									<div class="col-sm-5">
							...
							<div class="form-group">
									<label for="buyer" class="col-sm-6">Branch<i class="fa fa-asterisk req_asterisk"></i>
							...
							<div class="form-group">
									<label for="buyer" class="col-sm-6">Account No.<i class="fa fa-asterisk req_asterisk"></i>
									<span class="help-block" style="font-weight:normal;">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s</span>
									</label>
									<div class="col-sm-5">
							...
							<div class="form-group">
									<label for="buyer" class="col-sm-6">IFSC Code<i class="fa fa-asterisk req_asterisk"></i>
									<span class="help-block" style="font-weight:normal;">Lorem Ipsum is simply dummy text of the printing and typesetting industry. </span>
									</label>
									<div class="col-sm-5">
					...
					<div class="row">
						...
						<div class="widget">
							...
							<div class="widget-body dsk_mr80">
								<span class="form-horizontal no-margin ng-valid-parse ng-invalid ng-invalid-required ng-valid-min ng-valid-pattern ng-pristine" name="addPoi" role="form" confirm-on-exit="" novalidate="">
									<div class="form-group">
										<label for="buyer" class="col-sm-6">Payment Terms (Days)<i class="fa fa-asterisk req_asterisk"></i><span class="help-block" style="font-weight:normal;">Lorem Ipsum is simply dummy text of the printing and typesetting industry. </span></label>
										<div class="col-sm-5">
									...
									<div class="form-group">
									  <label for="buyer" class="col-sm-6">Default Currency<i class="fa fa-asterisk req_asterisk"></i><span class="help-block" style="font-weight:normal;">Lorem Ipsum is simply dummy text of the printing and typesetting industry. </span></label>
									  <div class="col-sm-5">
						...
						<div class="widget">
							...
							<div class="widget-body dsk_mr80">
								<span class="form-horizontal no-margin ng-valid-parse ng-invalid ng-invalid-required ng-valid-min ng-valid-pattern ng-pristine" name="addPoi" role="form" confirm-on-exit="" novalidate="">
									...
									<div class="form-group">
										<label for="Seller" class="col-sm-6">POs Creation
										<span class="help-block" style="font-weight:normal;">Lorem Ipsum is simply dummy text of the printing and typesetting industry. </span></label>
										<div class="col-sm-5">
										  <div class="cd-pricing-switcher clearfix">
											  <p class="fieldset pull-left">
												<input type="radio" name="po_creation" value="1" id="po_cre_y" @if(isset($data['maker_checker']['po_creation']) && $data['maker_checker']['po_creation']=='1') {{"checked"}} @endif>
									...
									<div class="form-group">
										<label for="Seller" class="col-sm-6">Invoice Approval
										<span class="help-block" style="font-weight:normal;">Lorem Ipsum is simply dummy text of the printing and typesetting industry. </span></label>
										<div class="col-sm-5">
										  <div class="cd-pricing-switcher clearfix">
											  <p class="fieldset pull-left">
												<input type="radio" name="invoice_approval" value="1" id="in_apr_y" @if(isset($data['maker_checker']['invoice_approval']) && $data['maker_checker']['invoice_approval']=='1') {{"checked"}} @endif>
									...
									<div id="close" @if(isset($data['other_configuration']['erp_integration']) && $data['other_configuration']['erp_integration']=='1')class="none"@endif>									
										<div class="form-group">
											<label for="Seller" class="col-sm-6">PI Upload
											<span class="help-block" style="font-weight:normal;">Lorem Ipsum is simply dummy text of the printing and typesetting industry. </span></label>
											<div class="col-sm-5">
											  <div class="cd-pricing-switcher clearfix">
												  <p class="fieldset pull-left">
