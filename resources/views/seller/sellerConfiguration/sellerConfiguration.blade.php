...
@section('sidebar')
	<ul>
		<li><a href="" class="heading">SELLER CONFIGURATION <i class="fa fa-info-circle" title="Lorem Ipsum is simply dummy text of the printing and typesetting industry."></i></a></li>
	</ul>	
@stop
@section('content')
	...
	<div class="widget">
		...
		<div class="widget-body dsk_mr80">
			<span class="form-horizontal no-margin ng-valid-parse ng-invalid ng-invalid-required ng-valid-min ng-valid-pattern ng-pristine" name="addPoi" role="form" confirm-on-exit="" novalidate="">
				...
				<div class="form-group">
					<label for="Seller" class="col-sm-6">Invoice Creation
...
<div class="row">
	...
	<div class="widget">
		...
		<div class="widget-body dsk_mr80">
			<span class="form-horizontal no-margin ng-valid-parse ng-invalid ng-invalid-required ng-valid-min ng-valid-pattern ng-pristine" name="addPoi" role="form" confirm-on-exit="" novalidate="">
				<div class="form-group">
					<label for="Seller" class="col-sm-6">Auto Discounting
					<span class="help-block" style="font-weight:normal;">Lorem Ipsum is simply dummy text of the printing and typesetting industry. </span></label>
					<div class="col-sm-5">
					  <div class="cd-pricing-switcher clearfix">
						  <p class="fieldset pull-left">
				...
				<div class="form-group">
					<label for="Seller" class="col-sm-6">Auto Accept PO
					<span class="help-block" style="font-weight:normal;">Lorem Ipsum is simply dummy text of the printing and typesetting industry. </span></label>
					<div class="col-sm-5">
					  <div class="cd-pricing-switcher clearfix">
						  <p class="fieldset pull-left">
							...
							<label for="accept_po_y">Yes</label>
							...
							<label for="accept_po_n">No</label>
							<span class="cd-switch"></span>
						  </p>
						</div>										
					</div>									
