						...
						<div class="widget-body dsk_mr80">
							<div class="form-horizontal no-margin ng-valid-parse ng-invalid ng-invalid-required ng-valid-min ng-valid-pattern ng-pristine" name="addPoi" role="form" confirm-on-exit="" novalidate="">
								...
								<div class="form-group">
									...
									<div class="col-sm-2">
								        <input type="text" class="form-control ng-pristine ng-untouched ng-invalid ng-invalid-required" auto-complete="off" id="discount" name="discount" placeholder="Discount" value="{{old('discount') or ''}}">
									</div>		
								</div>
								...
								<div class="form-group">
									<label for="invoice_no" class="col-sm-7 control-label">Sub Total</label>
									<div class="col-sm-4">
										<input type="text" class="form-control ng-pristine ng-untouched ng-invalid ng-invalid-required" id="subTotalDis" name="sub_amount" placeholder="Sub Total" value="" readonly>
									</div>	
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-4">
										<input type="text" class="form-control ng-pristine ng-untouched ng-invalid ng-invalid-required" id="finalAmount" name="final_amount" placeholder="Total" value="" readonly>
									</div>	
								</div>
