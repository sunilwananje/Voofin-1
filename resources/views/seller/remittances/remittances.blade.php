...
@section('sidebar')
	<ul>
		<li><a href="" class="heading">SELLER REMITTANCES <i class="fa fa-info-circle" title="Lorem Ipsum is simply dummy text of the printing and typesetting industry."></i></a></li>
	</ul>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <button type="button"><i class="fa fa-paperclip fa-lg"></i> Attachment</button>
                ...
                <button type="button"><i class="fa fa-pencil-square-o fa-lg"></i> Edit</button>

                <button type="button"><i class="fa fa-trash-o fa-lg"></i> Delelte </button>
